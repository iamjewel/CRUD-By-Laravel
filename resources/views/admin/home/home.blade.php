    ...
    <div class="row" style="margin-left: 90px; margin-top: 150px">
        ...
        <div class="col-lg-4">
            ...
            <div class="small-box bg-info">
                <div class="inner">
                    <h3 style="margin-left: 135px">58</h3>
                ...
                <a href="" class="small-box-footer">Check All Student <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-4" style="margin-left: 150px">
            ...
            <div class="small-box bg-success">
                <div class="inner">
                    <h3 style="margin-left: 138px">58</h3>
                ...
                <a href="" class="small-box-footer">Check All Department <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
